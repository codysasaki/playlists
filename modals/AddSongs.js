...
import { Button, Modal, Center, HStack, VStack, Text, Spacer, Pressable, FlatList, Heading, Box} from "native-base";
...
const renderItem = ({item}, props) =>{
    return(
    <Box borderBottomWidth="1" borderColor="primary.500" bg={item.selected ? "primary.800" : "secondary.800"} px="2" py="2">
        <>
          {item.selected ? (
        ...
        <Modal.Content bg ="secondary.800" maxWidth="400px">
          ...
          <Modal.Footer bg="secondary.700">
            <Button.Group space={2}>
              ...
              <Button onPress={() => {
              setShowModal(false); props.func(props.songList);
            }}>
                Save
              </Button>
            </Button.Group>
